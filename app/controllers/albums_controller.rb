class AlbumsController < ApplicationController
  ...
  private
    ...
    def album_params
      params.require(:album).permit(:label, :label_id, :title, :artist, :artist_id, :genre, :year, :added, :plays, :label_attributes => [:label, :id, :name], :artist_attributes => [:id, :artist_id, :name])
    end
end
